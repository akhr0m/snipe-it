            ...
            <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
                <div class="admin box box-default">
                    <div class="box-body text-center">
                        ...
                        <span class="keywords" aria-hidden="true"
                            style="display:none">{{ trans('admin/settings/general.keywords.oauth') }}</span>
                    ...
                    <div class="row-new-striped">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="https://www.gnu.org/licenses/agpl-3.0.en.html" target="_blank"
                                    data-tooltip="true" title="{{ trans('general.documentation') }}"><x-icon
                                        type="external-link" /></a>
                            </div>
                        </div>
                        <!-- / row -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="https://snipe-it.readme.io/reference/api-overview" target="_blank"
                                    data-tooltip="true" title="{{ trans('general.documentation') }}"><x-icon
                                        type="external-link" /></a>
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="https://snipe-it.readme.io/docs/scim" target="_blank" data-tooltip="true"
                                    title="{{ trans('general.documentation') }}"><x-icon type="external-link" /></a>
