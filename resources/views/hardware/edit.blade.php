...
@section('inputFields')
    ...
    <div class="form-group {{ ($errors->has('asset_tag') || $errors->has('asset_tags.1')) ? ' has-error' : '' }}">
      <label for="asset_tag" class="col-md-3 control-label">{{ trans('admin/hardware/form.tag') }}</label>
        @if ($item->id)
            @isset($next_asset_tag)
                <div class="col-md-7 col-sm-12">
                    <input class="form-control" type="text" name="asset_tags[1]" id="asset_tag" value="{{ $next_asset_tag }}" readonly required>
                ...
                <div class="col-md-2 col-sm-12" style="display: none;">
                     <button class="add_field_button btn btn-theme btn-sm" name="add_field_button">
                        <x-icon type="plus" />
