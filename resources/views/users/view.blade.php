...
{{-- Tombol Cetak BAST yang salah posisi sudah dihapus dari sini --}}
    ...
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs hidden-print">
        ...
        <li>
          <a href="#asset" data-toggle="tab">
            <span class="hidden-lg hidden-md">
            <i class="far fa-barcode fa-2x"></i>
            </span>
        ...
        <li>
          <a href="#history" data-toggle="tab">
            <span class="hidden-lg hidden-md">
                <i class="far fa-history fa-2x"></i>
            </span>
      ...
      @can('update', $user)
        ...
        @can('update', \App\Models\User::class)
          <li class="pull-right">
              ...
              <span class="hidden-xs"><i class="fa-fw fas fa-paperclip"></i></span>
              <span class="hidden-lg hidden-md hidden-xl"><i class="fa-fw fas fa-paperclip fa-2x"></i></span>
      ...
      <div class="tab-content">
        ...
        <div class="info-stack-container">
                  ...
                  <div class="col-md-12" style="padding-top: 5px;">
                    <form action="{{ route('users/bulkedit') }}" method="POST">
                      ...
                      <button class="btn btn-block btn-sm btn-danger btn-social hidden-print">
                          <i class="fa fa-checkin-and-delete"></i>
            ...
            <div class="col-md-9 col-xs-12 col-sm-pull-3 info-stack">
                ...
                <div class="row-new-striped">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-9">
                          ...
                          @if ($user->isSuperUser())
                            <span class="label label-danger" data-tooltip="true" title="{{ trans('general.superuser_tooltip') }}"><i class="fas fa-crown" title="{{ trans('general.superuser') }}"></i></span>&nbsp;
                          @elseif ($user->hasAccess('admin'))
                            <span class="label label-warning" data-tooltip="true" title="{{ trans('general.admin_tooltip') }}"><i class="fas fa-crown" title="{{ trans('general.admin_user') }}"></i></span>&nbsp;
                          @endif
                            {{ $user->username }}
                      ...
                      @if ($user->website)
                        <div class="row">
                         ...
                         <div class="col-md-9">
                             <a href="{{ $user->website }}" target="_blank"><i class="fa fa-external-link-alt"></i> {{ $user->website }}</a>
                         </div>
                       </div>
                      @endif
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-9">
                              ...
                              <a id="optional_info" class="text-primary">
                                  <i class="fa fa-caret-right" id="optional_info_icon"></i>
                    ...
                    </div> </div> </div></div> </div><div class="tab-pane" id="asset">
            ...
            </div><div class="tab-pane" id="licenses">
            ...
            </div><div class="tab-pane" id="accessories">
              <div class="table-responsive">
                <table
            ...
            </div><div class="tab-pane" id="consumables">
              <div class="table-responsive">
                <table
              ...
              </div> </div><div class="tab-pane" id="history">
              <div class="table-responsive">
            ...
            </div><div class="tab-pane" id="managed-locations">
...
$('#dataConfirmModal').on('show.bs.modal', function (event) {
  ...
  $("#two_factor_reset").click(function(){
    ...
    $("#two_factor_reseticon").html('<i class="fas fa-spinner fa-spin"></i>');
    $.ajax({
      ...
      success: function (data) {
        $("#two_factor_reset_toggle").html('').html('<span class="text-danger"><i class="fa fa-times-circle"></i> {{ trans('general.no') }}</span>');
        $("#two_factor_reseticon").html('');
        $("#two_factor_resetstatus").html('<span class="text-success"><i class="fa fa-check-circle fa-2x"></i> ' + data.message + '</span>');
    ...
    $('#fileupload').fileupload({
        ...
        progress: function (e, data) {
            ...
            if (data && data.jqXHR && data.jqXHR.responseJSON && data.jqXHR.responseJSON.status === "error") {
                ...
                $('.progress-checkmark').fadeIn('fast').html('<i class="fa fa-times-circle fa-3x text-danger"></i>');
            } else {
                ...
                $('.progress-checkmark').fadeIn('fast').html('<i class="fa fa-check-circle fa-3x text-success"></i>');
