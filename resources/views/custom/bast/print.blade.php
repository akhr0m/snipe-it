...
<body>
    ...
    @php
        ...
        $perihalText = $isReprint ? $report->perihal : 'Transaksi Aset (Inventaris Kantor)';
    ...
    <div class="container">
        ...
        <div class="header-logo">
            ...
            <div class="logo-text">
                <h3>RMK Group</h3>
                <p>Jalan Puri Kencana Blok M4 No.1 RT.002/RW.07, Kel. Kembangan Selatan,<br>Kec. Kembangan, Kota Jakarta
                    Barat 11610</p>
            </div>
        </div>
            ...
            <div class="meta-col">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="colon-separator">:</td>
                        <td>
                            <span id="admin-nik-field" {!! !$isReprint ? 'class="editable" contenteditable="true"' : '' !!}
                                style="min-width: 150px; display: inline-block;">{{ $isReprint ? $report->admin_nik : '' }}</span>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="meta-col">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="colon-separator">:</td>
                        <td>
                            <span id="user-nik-field" {!! !$isReprint ? 'class="editable" contenteditable="true"' : '' !!}
                                style="min-width: 150px; display: inline-block;">{{ $isReprint ? $report->user_nik : '' }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="meta-label">Lokasi</td>
                    ...
                    <tr>
                        ...
                        <td class="colon-separator">:</td>
                        <td>
                            <span id="perihal-field" {!! !$isReprint ? 'class="editable" contenteditable="true"' : '' !!}
                                style="min-width: 200px; display: inline-block;">{{ $perihalText }}</span>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <tbody>
                @foreach ($items as $index => $item)
                    <tr data-id="{{ $item['id'] }}">
                        ...
                        <td class="asset-keterangan {!! !$isReprint ? 'editable' : '' !!}" {!! !$isReprint ? 'contenteditable="true"' : '' !!}>
                            {{ $item['keterangan'] }}</td>
                    </tr>
                @endforeach
            </tbody>
        ...
        <table class="sig-block">
            ...
            <tr>
                ...
                <td>
                    <div class="sig-name" style="color: #777; font-weight: normal; font-style: italic;">Atasan Langsung
                        YBS</div>
                </td>
                <td>
        ...
        <div class="notes-box {!! !$isReprint ? 'editable' : '' !!}" id="notes-field" {!! !$isReprint ? 'contenteditable="true"' : '' !!}>{{ $notesText }}
        </div>
        ...
        <div class="notes-label" style="font-weight: bold; margin-bottom: 2px;">Notes:</div>
        <div class="notes-box {!! !$isReprint ? 'editable' : '' !!}" id="notes-return-field" {!! !$isReprint ? 'contenteditable="true"' : '' !!}>
            {{ $returnNotesText }}</div>

        <!-- Print Action Bar (Hidden during printing) -->
        <div class="action-bar hidden-print">
            @if (!$isReprint)
                <button class="btn btn-success" id="btn-save-print"
                    style="padding: 6px 20px; font-size: 12px; font-weight: bold;">
            ...
            <button class="btn btn-default" onclick="window.close()"
                style="padding: 6px 20px; font-size: 12px; margin-left: 10px;">
                Tutup
            </button>
        </div>
    </div>
