...
@section('moar_scripts')
    <script>
        $(document).ready(function () {
            ...
            const findBastBtn = document.getElementById('findBastBtn');
            if (findBastBtn) {
                findBastBtn.addEventListener('click', function () {
                    const bastNumber = document.getElementById('number').value.trim();
                    const errorMessageDiv = document.getElementById('error-message');
                    errorMessageDiv.style.display = 'none';

                    if (!bastNumber) {
                        errorMessageDiv.innerText = 'Silakan masukkan Nomor BAST.';
